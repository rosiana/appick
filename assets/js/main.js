...
$(function(){
  $('.carousel-ex-next-page').click(function(){
    var carousel = $(this).parents('.carousel-ex').find('ul');
  ...
  $('.carousel-ex-prev-page').click(function(){
    var carousel = $(this).parents('.carousel-ex').find('ul');
    var scroll = carousel.scrollLeft();
    var w = carousel.width();
    var x = 0;
  ...
  $('.carousel-ex-next-image').click(function(){
    var carousel = $(this).parents('.carousel-ex').find('ul');
    var scroll = carousel.scrollLeft();
    var x = 0;
  ...
  $('.carousel-ex-prev-image').click(function(){
    var carousel = $(this).parents('.carousel-ex').find('ul');
    var scroll = carousel.scrollLeft();
    var x = 0;
    carousel.find('li').each(function(){
